class AttributesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attribute.save
        format.html { redirect_to attribute_url(@attribute), notice: "Attribute was successfully created." }
  ...
  def update
    respond_to do |format|
      if @attribute.update(attribute_params)
        format.html { redirect_to attribute_url(@attribute), notice: "Attribute was successfully updated." }
